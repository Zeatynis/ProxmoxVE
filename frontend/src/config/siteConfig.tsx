...
export const navbarLinks = [
  {
    href: `https://github.com/Zeatynis/${basePath}`,
    event: "Github",
  ...
  {
    href: `https://github.com/Zeatynis/${basePath}/blob/main/CHANGELOG.md`,
    event: "Change Log",
    icon: <Scroll className="h-4 w-4" />,
    text: "Change Log",
  },
  {
    href: `https://github.com/Zeatynis/${basePath}/discussions`,
    event: "Discussions",
